/*
* Removed Infistar files. You will need to put them back in to gain full functionality.
* You will also need to modify Infistar to allow launchers and such to be used without banning players.
*/
...
/*	OLD CODE - Replaced By Vector Code
dayz_objectUID2 = {
