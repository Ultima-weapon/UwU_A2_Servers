if (isServer) then {
  ...
  //Bandit Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\bandit.sqf";
  //Bilgrad City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\bilgrad.sqf";
  //Branibor City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\branibor.sqf";
  //Hero Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\hero.sqf";
  //Lyepenstok City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\lyepestok.sqf";
  //Misc. Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\miscvendors.sqf";
  //Sabina City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\sabina.sqf";
  //Wholesalers
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Tavi\wholesalers.sqf";
