...
if (isServer) then {
	...
	private ["_ainum","_vehicle","_aiskin","_skin","_mission","_aitype","_aicskill","_gunner","_gunner2","_gunner3","_wpnum","_radius","_skillarray","_startingpos","_veh_class","_veh","_unitGroup","_pilot","_skill","_position","_wp"];
	...
	// Gunners ///////////////////////////////
	if (_vehicle isKindOf "BMP2_INS" || _vehicle isKindOf "ZSU_INS" || _vehicle isKindOf "T72_INS") then {
