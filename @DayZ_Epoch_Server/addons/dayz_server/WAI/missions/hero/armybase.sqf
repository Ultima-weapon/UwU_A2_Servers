...
if(isServer) then {
	...
	private 		["_complete","_crate_type","_mission","_position","_crate","_n1","_n2","_n3","_rV","_rHeli","_baserunover","_baserunover1","_baserunover2"];
	...
	//Troops
	[[(_position select 0) - 12, (_position select 1) + 2, 0],2,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 2, (_position select 1) + 2, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 14, (_position select 1) - 35, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 13, (_position select 1) + 35, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	...
	[[(_position select 0) - 22, (_position select 1) - 56, 0],[(_position select 0)+3000, (_position select 1)+3000, 1000],600,"MV22","HMMWV_Armored",20,50,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;	
