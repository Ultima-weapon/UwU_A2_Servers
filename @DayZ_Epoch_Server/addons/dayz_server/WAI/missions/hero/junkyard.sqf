...
if(isServer) then {
	...
	_baserunover24 = createVehicle ["MAP_Kitchenstove_Elec", [(_position select 0) - 11, (_position select 1) + 1.511,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) - 2, (_position select 1) - 5, 0],3,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 19, (_position select 1) + 19, 0],3,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 17, (_position select 1) + 21, 0],3,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
