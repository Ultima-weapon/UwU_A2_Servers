...
if(isServer) then {
	...
	[_mission,_position,"Hard","Bandit Base","MainHero",true,true,600] call mission_init;
	...
	_n1=50+round(random 50); _n2=50+round(random 50); _rV = armed_armored_vehicles call BIS_fnc_selectRandom;
		[[(_position select 0)-_n1, (_position select 1)+_n2, 0],[(_position select 0)-_n1-3000, (_position select 1)+_n2+3000, 1000],300,"MV22",_rV,20,300,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;
		[[(_position select 0)+_n1, (_position select 1)+_n2, 0],[(_position select 0)-_n1-2500, (_position select 1)+_n2+2500, 1000],100,"C130J","ZSU_INS",20,400,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;
	...
	//Humvee Patrol
	[[(_position select 0) + 100, _position select 1, 0],[(_position select 0)-3000,(_position select 1)-3000,1000],600,"MV22","HMMWV_M1151_M2_DES_EP1",2,50,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;
	...
	//Heli Paradrop
	[[(_position select 0), (_position select 1), 0],[(_position select 0)+3000,(_position select 1)+3000,0],400,"UH1H_DZ",10,"Random","Random",4,"Random","Bandit","Random","Bandit",true,_mission] spawn heli_para;
