...
[[(_position select 0) - 11, (_position select 1) + 9, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 15, (_position select 1) - 15, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 2, (_position select 1) + 18, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
[[(_position select 0) + 55, _position select 1, 0],[(_position select 0)-3000,(_position select 1)+3000,1000],600,"MV22","HMMWV_Armored",2,50,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;
