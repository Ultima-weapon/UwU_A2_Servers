...
if(isServer) then {
	...
	[_mission,_position,"Easy","Medical Supply Camp","MainHero",true,true,600] call mission_init;
	...
	//Troops
	[[_position select 0,_position select 1,0],3,"Easy",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
