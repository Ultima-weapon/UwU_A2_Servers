...
if(isServer) then {
	...
	[[(_position select 0) + 11, (_position select 1) + 41, 0],2,"hard","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
	[[(_position select 0) - 12, (_position select 1) - 43, 0],2,"random","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
	[[(_position select 0) - 13, (_position select 1) - 43, 0],2,"random","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
