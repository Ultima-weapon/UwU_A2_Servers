...
if(isServer) then {
	...
	[_mission,_position,"Hard","Disabled Convoy","MainHero",true,true,600] call mission_init;
	...
	//Heli Para Drop
	[[(_position select 0),(_position select 1),0],[(_position select 0)-3000,(_position select 1)-3000,0],400,"BAF_Merlin_HC3_D",10,"Random","Random",4,"Random","Bandit","Random","Bandit",false,_mission] spawn heli_para;
