...
[[(_position select 0) + 9, (_position select 1) - 13, 0],_num,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 13, (_position select 1) + 15, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) - 23, (_position select 1) - 25, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) - 13, (_position select 1) + 15, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
[[(_position select 0) + 55, _position select 1, 0],[(_position select 0)+3000, (_position select 1)+3000, 1000],600,"MV22","HMMWV_Armored",20,50,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;	
...
//Heli Paradrop
[[(_position select 0), (_position select 1), 0],[(_position select 0)-3000,(_position select 1)-3000,0],200,"UH1H_DZ",10,"Hard","Random",4,"Random","Bandit","Random","Bandit",true,_mission] spawn heli_para;
