...
if(isServer) then {
	...
	//Troops
	[[(_position select 0) + 9, (_position select 1) - 13, 0],2,"Easy",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 13, (_position select 1) + 15, 0],2,"Easy","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 23, (_position select 1) - 25, 0],2,"Easy","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 13, (_position select 1) + 15, 0],2,"Easy","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
