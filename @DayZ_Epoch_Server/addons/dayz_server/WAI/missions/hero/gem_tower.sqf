...
if(isServer) then {
	...
	private 		["_complete","_baserunover","_mission","_directions","_position","_crate","_n1","_n2","_n3","_rHeli","_num","_crate_type","_baserunover0","_baserunover1","_baserunover2","_baserunover3","_baserunover4","_baserunover5","_baserunover6","_baserunover7"];
	...
	[[(_position select 0) + 21, (_position select 1) + 19, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 23, (_position select 1) - 19, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 12, (_position select 1) + 23, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 18, _position select 1, 0],2,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
