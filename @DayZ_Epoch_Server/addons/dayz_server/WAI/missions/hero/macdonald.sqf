...
if(isServer) then {
	...
	//Troops
	[[(_position select 0) - 1, (_position select 1) - 10, 0],3,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 2, (_position select 1) - 50, 0],3,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 1, (_position select 1) + 11, 0],3,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	...
	[[(_position select 0) - 27, (_position select 1) - 18, 0],[(_position select 0)+3000, (_position select 1)+3000, 1000],600,"MV22","Offroad_DSHKM_Gue_DZ",20,50,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;	
