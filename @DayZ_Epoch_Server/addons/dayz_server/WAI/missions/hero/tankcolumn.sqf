...
if(isServer) then {
	...
	private 		["_complete","_crate_type","_mission","_position","_crate","_n1","_n2","_rV","_baserunover1","_baserunover2","_baserunover3","_baserunover4","_baserunover5","_baserunover6","_baserunover7","_baserunover8","_baserunover9","_baserunover10","_baserunover11","_baserunover12","_baserunover13"];
	...
	_baserunover2 = [[(_position select 0) + 2.2, (_position select 1) - 12,-0.02],[(_position select 0) + 2.2, (_position select 1) - 12,-0.02],0,0,"T34","Hard","Bandit","Bandit",_mission] call vehicle_patrol;
	_baserunover3 = [[(_position select 0) + 12.2, (_position select 1) - 12,-0.02],[(_position select 0) + 12.2, (_position select 1) - 12,-0.02],0,0,"T34","Hard","Bandit","Bandit",_mission] call vehicle_patrol;
	_baserunover4 = [[(_position select 0) + 21, (_position select 1) - 13,-0.02],[(_position select 0) + 21, (_position select 1) - 13,-0.02],0,0,"T34","Hard","Bandit","Bandit",_mission] call vehicle_patrol;
	_baserunover5 = [[(_position select 0) + 29, (_position select 1) - 16,-0.02],[(_position select 0) + 29, (_position select 1) - 16,-0.02],0,0,"T34","Hard","Bandit","Bandit",_mission] call vehicle_patrol;
	...
	_baserunover 	= [_baserunover1,_baserunover6,_baserunover7,_baserunover8,_baserunover9,_baserunover10,_baserunover11,_baserunover12,_baserunover13];
	
	_directions = [0,0,0,90.007,0,0,0,0,0];
	{ _x setDir (_directions select _forEachIndex) } forEach _baserunover;
	
	{ _x setVectorUp surfaceNormal position  _x; } count _baserunover;
	
	//Troops
	[[(_position select 0) - 7, (_position select 1) - 10, 0],3,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 16, (_position select 1) - 5, 0],3,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 4, (_position select 1) + 18, 0],3,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	...
	//Humvee Patrol
	// [[(_position select 0) + 22, (_position select 1) + 32, 0],[(_position select 0) + 15, (_position select 1) - 33, 0],50,2,"M113_TK_EP1","Hard","Bandit","Bandit",_mission] call vehicle_patrol;
	[[(_position select 0) + 22, (_position select 1) + 32, 0],[(_position select 0)+3000, (_position select 1)+3000, 1000],600,"MV22","M113_TK_EP1",20,50,"Hard","Bandit","Bandit",false,_mission] spawn heli_para_veh;	
