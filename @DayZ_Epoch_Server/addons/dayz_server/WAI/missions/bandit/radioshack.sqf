...
if(isServer) then {
	...
	private 		["_baserunover0","_baserunover1","_baserunover2","_baserunover3","_baserunove4","_baserunover5","_baserunover6","_baserunover7","_baserunover8","_baserunover9","_baserunover10","_baserunover11","_baserunover12","_baserunover13","_baserunover14","_mission","_directions","_position","_crate","_n1","_n2","_rV","_crate_type","_num"];
	...
	[[(_position select 0) + 14, (_position select 1) - 3, 0],2,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
