...
if(isServer) then {
	...
	private			["_complete","_president_himself","_crate_type","_mission","_position","_crate","_n1","_n2","_n3","_rV","_rHeli","_rndnum","_baserunover","_president","_firstlady"];

	// Get mission number, important we do this early
	_mission 		= count wai_mission_data -1;

	_position		= [80] call find_position;
	[_mission,_position,"Extreme","Presidents in Town","MainBandit",true,true,900] call mission_init;
	...
	//Humvee Patrol
	[[(_position select 0) + 100, _position select 1, 0],[(_position select 0)-3000,(_position select 1)-3000,0],800,"MV22","HMMWV_Avenger_DES_EP1",2,50,"random","random","Hero",false,_mission] spawn heli_para_veh;
	
	//Heli Paradrop
	[[(_position select 0),(_position select 1),0],[(_position select 0)+3000,(_position select 1)+3000,0],800,"UH60M_EP1_DZE",6,"Random","Random",4,"Random","Hero","Random","Hero",true,_mission] spawn heli_para;
	[[(_position select 0) + 50,(_position select 1),0],[(_position select 0)+3000,(_position select 1)-3000,0],800,"UH60M_EP1_DZE",6,"Random","Random",4,"Random","Hero","Random","Hero",true,_mission] spawn heli_para;
	[[(_position select 0) + 100,(_position select 1),0],[(_position select 0)-3000,(_position select 1)+3000,0],800,"UH60M_EP1_DZE",6,"Random","Random",4,"Random","Hero","Random","Hero",true,_mission] spawn heli_para;
