...
if(isServer) then {
	...
	private 		["_complete","_dir","_num","_num2","_crate_type","_mission","_position","_vehclass2","_vehicle2","_playerPresent","_vehicle","_vehclass","_crate","_crate2","_crate3","_crate4","_crate5","_crate6","_crate7","_crate8","_rndChopper"];
	
	// Get mission number, important we do this early
	_mission 		= count wai_mission_data -1;
	
	_position		= [80] call find_position;
	[_mission,_position,"Extreme","Death Match","MainBandit",true,true,900] call mission_init;
	...
	[[(_position select 0)-_num2,(_position select 1)-_num2,0],_num,"random","Random",7,"Random","Hero","Random","Hero",_mission] call spawn_group;
	...
	_num2 = 5 + round (random 25);
	[[(_position select 0)+_num2,(_position select 1)-_num2,0],_num,"random",["Random","AA"],7,"Random","Hero","Random","Hero",_mission] call spawn_group;
	_num = 2 + round (random 1); 
	_num2 = 5 + round (random 25);
	[[(_position select 0)+_num2,(_position select 1)-_num2,0],_num,"random",["Random","AT"],7,"Random","Hero","Random","Hero",_mission] call spawn_group;
	...
	[[(_position select 0)+_num, (_position select 1)+_num2, 0],[(_position select 0)-3000,(_position select 1)-3000,1000],600,"MV22","HMMWV_Avenger_DES_EP1",2,100,"random","random","Hero",false,_mission] spawn heli_para_veh;
	_num = 50 + round (random 50); 
	_num2 = 50 + round (random 50);
	[[(_position select 0)+_num, (_position select 1)+_num2, 0],[(_position select 0)-3000,(_position select 1)+3000,1000],500,"MV22","HMMWV_TOW_DES_EP1",2,100,"random","random","Hero",false,_mission] spawn heli_para_veh;
	_num = 50 + round (random 50); 
	_num2 = 50 + round (random 50);
	[[(_position select 0)+_num, (_position select 1)+_num2, 0],[(_position select 0)+3000,(_position select 1)-3000,1000],400,"MV22","HMMWV_M1151_M2_DES_EP1",2,100,"random","random","Hero",false,_mission] spawn heli_para_veh;
	_num = 50 + round (random 50); 
	_num2 = 50 + round (random 50);
	[[(_position select 0)+_num, (_position select 1)+_num2, 0],[(_position select 0)+3000,(_position select 1)+3000,1000],300,"MV22","HMMWV_M1151_M2_DES_EP1",2,100,"random","random","Hero",false,_mission] spawn heli_para_veh;
	...
	[[[(_position select 0) - _num, (_position select 1) + _num2, 0]],"random","random","Hero","Hero","random",7,"random","random",_mission] call spawn_static;
	_num = 30 + round (random 10); 
	_num2 = 30 + round (random 10);
	[[[(_position select 0) + _num, (_position select 1) - _num2, 0]],"random","random","Hero","Hero","random",7,"random","random",_mission] call spawn_static;
	_num = 30 + round (random 10); 
	...
	[[(_position select 0), (_position select 1), 0],[(_position select 0)-3000,(_position select 1)-3000,0],600,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)+3000,(_position select 1)+3000,0],600,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)-3000,(_position select 1)+3000,0],500,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)+3000,(_position select 1)-3000,0],500,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)+3000,(_position select 1)+3000,0],400,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)-3000,(_position select 1)-3000,0],400,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)+3000,(_position select 1)-3000,0],300,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	_rndChopper = air_attack_vehicles call BIS_fnc_selectRandom;
	[[(_position select 0), (_position select 1), 0],[(_position select 0)-3000,(_position select 1)+3000,0],300,_rndChopper,0,"random","random",1,"random","Hero","random","Hero",true,_mission] spawn heli_para;
	...
	_complete = [
		...
		[_vehicle,_vehicle2],			// cleanup objects
	...
	if (_complete) then {
		[_crate,[10,ai_wep_assault],[5,crate_tools],25,1] call dynamic_crate;
		[_crate2,[10,ai_wep_machine],[5,crate_tools],[4,crate_items_chainbullets],1] call dynamic_crate;
		[_crate3,[10,ai_wep_sniper],[5,crate_tools_sniper],[4,crate_items_sniper],1] call dynamic_crate;
		...
		[_crate6,[5,crate_weapons_buildables],[4,crate_tools_buildable],[50,crate_items_buildables],1] call dynamic_crate;
		[_crate7,0,[5,crate_tools],[50,crate_items],1] call dynamic_crate;
		[_crate8,0,[5,crate_tools],[50,crate_items_food],1] call dynamic_crate;
	};
