...
if(isServer) then {
	...
	//Troops
	[[(_position select 0) - 12, (_position select 1) + 2, 0],3,"Hard",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 2, (_position select 1) + 2, 0],3,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 14, (_position select 1) - 35, 0],3,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 13, (_position select 1) + 35, 0],3,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	...
	[[(_position select 0) - 22, (_position select 1) - 56, 0],[(_position select 0)+3000, (_position select 1)+3000, 1000],500,"MV22","HMMWV_Armored",20,50,"Hard","Hero","Hero",false,_mission] spawn heli_para_veh;
