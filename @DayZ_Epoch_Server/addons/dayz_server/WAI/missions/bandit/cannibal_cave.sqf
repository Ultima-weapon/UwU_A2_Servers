...
if(isServer) then {
	...
	private 		["_baserunover","_mission","_directions","_position","_crate","_crate_type","_n1","_n2","_n3","_rHeli","_num"];
	...
	[[(_position select 0) + 12, (_position select 1) + 42.5, 0],_num,"extreme",["random","at"],4,"random","Hero","random",["Hero",150],_mission] call spawn_group;
	[[(_position select 0) + 11, (_position select 1) + 41, 0],2,"hard","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 12, (_position select 1) - 43, 0],2,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 13, (_position select 1) - 43, 0],2,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
