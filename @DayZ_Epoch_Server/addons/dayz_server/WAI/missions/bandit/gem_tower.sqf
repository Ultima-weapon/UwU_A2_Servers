...
if(isServer) then {
	...
	[[(_position select 0) + 21, (_position select 1) + 19, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 23, (_position select 1) - 19, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 12, (_position select 1) + 23, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 18, _position select 1, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
