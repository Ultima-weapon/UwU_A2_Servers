...
[[(_position select 0) + 9, (_position select 1) - 13, 0],_num,"Hard",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[[(_position select 0) + 13, (_position select 1) + 15, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[[(_position select 0) - 23, (_position select 1) - 25, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[[(_position select 0) - 13, (_position select 1) + 15, 0],2,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
