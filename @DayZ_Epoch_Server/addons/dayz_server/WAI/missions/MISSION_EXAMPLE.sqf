...
if(isServer) then {
	...
	[[(_position select 0)+_num2, (_position select 1)+_num2, 0],[-300,0,0],30000,"C130J","HMMWV_M1151_M2_DES_EP1",2,100,"random","random","bandit",false,_mission] spawn heli_para_veh;
