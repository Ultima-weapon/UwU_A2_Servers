private ["_player","_object","_garage","_class","_cid","_objectID","_objectUID","_newUID","_fuel","_damage","_inventory","_hitpoints","_array","_hit","_selection","_storedata","_stored","_colour1","_colour2","_newlist"];
...
_newUID = str(round(random(1000000)));
...
_storedata = [_newUID,_class,_cid,_colour1,_colour2,_inventory,_fuel,_damage,_array];
