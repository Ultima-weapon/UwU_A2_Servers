...
//Spawn probabilities
DZAI_spawnChance0 = 0.30;	//Spawn chance for low-skill AI typically found in small towns (Default: 0.40)
...
if((toLower worldName) == 'jadegroove') then {	DZAI_maxHeliPatrols = 1; } else { DZAI_maxHeliPatrols = 3; };
...
if((toLower worldName) == 'jadegroove') then {	DZAI_maxLandPatrols = 0; } else { DZAI_maxLandPatrols = 6; };
...
DZAI_skill0 = [["aimingAccuracy",0.05,0.10],["aimingShake",0.90,1],["aimingSpeed",0.05,0.10],["endurance",0.05,0.10],["spotDistance",0.05,0.10],["spotTime",0.05,0.10],["courage",0.05,0.10],["reloadSpeed",0.05,0.10],["commanding",0.05,0.10],["general",0.05,0.10]];
//AI skill settings level 1 (Skill, Minimum skill, Maximum skill). Baseline skill level: 0.60
DZAI_skill1 = [["aimingAccuracy",0.10,0.12],["aimingShake",0.80,0.89],["aimingSpeed",0.10,0.12],["endurance",0.10,0.12],["spotDistance",0.10,0.12],["spotTime",0.10,0.12],["courage",0.10,0.12],["reloadSpeed",0.10,0.12],["commanding",0.10,0.12],["general",0.10,0.12]];
//AI skill settings level 2 (Skill, Minimum skill, Maximum skill). Baseline skill level: 0.70
DZAI_skill2 = [["aimingAccuracy",0.12,0.15],["aimingShake",0.70,0.79],["aimingSpeed",0.12,0.15],["endurance",0.12,0.15],["spotDistance",0.12,0.15],["spotTime",0.12,0.15],["courage",0.12,0.15],["reloadSpeed",0.12,0.15],["commanding",0.12,0.15],["general",0.12,0.15]];
//AI skill settings level 3 (Skill, Minimum skill, Maximum skill). Baseline skill level: 0.80
DZAI_skill3 = [["aimingAccuracy",0.15,0.20],["aimingShake",0.60,0.69],["aimingSpeed",0.15,0.20],["endurance",0.15,0.20],["spotDistance",0.15,0.20],["spotTime",0.15,0.20],["courage",0.15,0.20],["reloadSpeed",0.15,0.20],["commanding",0.15,0.20],["general",0.15,0.20]];
...
DZAI_metalBars = ["ItemGoldBar", "ItemSilverBar", "ItemTinBar", "ItemAluminumBar", "ItemObsidian", "ItemAmethyst", "ItemCitrine", "ItemEmerald", "ItemRuby", "ItemSapphire", "ItemTopaz", "PartOre", "PartOreSilver", "PartOreGold"];
