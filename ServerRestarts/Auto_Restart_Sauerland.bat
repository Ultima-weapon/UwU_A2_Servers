@echo off
title Auto_Server_Restart_Sauerland
set Arma_Path=C:\###DrivePath###
set Arma_Mods=@DayzOverwatch;@DayzOrigins;@DayZ_Epoch;@DayZ_Epoch_Server
Set Arma_Name=DayZConfig_Sauerland
Set Arma_Config=DayZConfig_Sauerland\server.cfg
Set Arma_Cfg=DayZConfig_Sauerland\basic.cfg
Set Arma_Profiles=DayZConfig_Sauerland
set ServerEXE=arma2oaserver_Sauerland.exe
...
:: 0005 - 0400
if %timeStamp% GEQ 0235.00 if %timeStamp% LSS 0300.00 goto Msg01
if %timeStamp% GEQ 0300.00 if %timeStamp% LSS 0330.00 goto Msg02
if %timeStamp% GEQ 0330.00 if %timeStamp% LSS 0400.00 goto Msg03
if %timeStamp% GEQ 0400.00 if %timeStamp% LSS 0430.00 goto Msg04
if %timeStamp% GEQ 0430.00 if %timeStamp% LSS 0500.00 goto Msg05
if %timeStamp% GEQ 0500.00 if %timeStamp% LSS 0530.00 goto Msg06
if %timeStamp% GEQ 0530.00 if %timeStamp% LSS 0600.00 goto Msg07
if %timeStamp% GEQ 0600.00 if %timeStamp% LSS 0615.00 goto Msg08
if %timeStamp% GEQ 0615.00 if %timeStamp% LSS 0620.00 goto Msg09
if %timeStamp% GEQ 0620.00 if %timeStamp% LSS 0625.00 goto Msg10
if %timeStamp% GEQ 0625.00 if %timeStamp% LSS 0626.00 goto Msg11
if %timeStamp% GEQ 0626.00 if %timeStamp% LSS 0627.00 goto Msg12
if %timeStamp% GEQ 0627.00 if %timeStamp% LSS 0628.00 goto Msg13
if %timeStamp% GEQ 0628.00 if %timeStamp% LSS 0629.00 goto Msg14
if %timeStamp% GEQ 0629.00 if %timeStamp% LSS 0629.30 goto Msg15
if %timeStamp% GEQ 0629.30 if %timeStamp% LSS 0629.45 goto Msg16
if %timeStamp% GEQ 0629.45 if %timeStamp% LSS 0629.50 goto Msg17
if %timeStamp% GEQ 0629.50 if %timeStamp% LSS 0629.55 goto Msg18
if %timeStamp% GEQ 0629.55 if %timeStamp% LSS 0635.00 goto Msg19
:: 0405 - 0800
if %timeStamp% GEQ 0635.00 if %timeStamp% LSS 0700.00 goto Msg01
if %timeStamp% GEQ 0700.00 if %timeStamp% LSS 0730.00 goto Msg02
if %timeStamp% GEQ 0730.00 if %timeStamp% LSS 0800.00 goto Msg03
if %timeStamp% GEQ 0800.00 if %timeStamp% LSS 0830.00 goto Msg04
if %timeStamp% GEQ 0830.00 if %timeStamp% LSS 0900.00 goto Msg05
if %timeStamp% GEQ 0900.00 if %timeStamp% LSS 0930.00 goto Msg06
if %timeStamp% GEQ 0930.00 if %timeStamp% LSS 1000.00 goto Msg07
if %timeStamp% GEQ 1000.00 if %timeStamp% LSS 1015.00 goto Msg08
if %timeStamp% GEQ 1015.00 if %timeStamp% LSS 1020.00 goto Msg09
if %timeStamp% GEQ 1020.00 if %timeStamp% LSS 1025.00 goto Msg10
if %timeStamp% GEQ 1025.00 if %timeStamp% LSS 1026.00 goto Msg11
if %timeStamp% GEQ 1026.00 if %timeStamp% LSS 1027.00 goto Msg12
if %timeStamp% GEQ 1027.00 if %timeStamp% LSS 1028.00 goto Msg13
if %timeStamp% GEQ 1028.00 if %timeStamp% LSS 1029.00 goto Msg14
if %timeStamp% GEQ 1029.00 if %timeStamp% LSS 1029.30 goto Msg15
if %timeStamp% GEQ 1029.30 if %timeStamp% LSS 1029.45 goto Msg16
if %timeStamp% GEQ 1029.45 if %timeStamp% LSS 1029.50 goto Msg17
if %timeStamp% GEQ 1029.50 if %timeStamp% LSS 1029.55 goto Msg18
if %timeStamp% GEQ 1029.55 if %timeStamp% LSS 1035.00 goto Msg19
:: 0805 - 1200
if %timeStamp% GEQ 1035.00 if %timeStamp% LSS 1100.00 goto Msg01
if %timeStamp% GEQ 1100.00 if %timeStamp% LSS 1130.00 goto Msg02
if %timeStamp% GEQ 1130.00 if %timeStamp% LSS 1200.00 goto Msg03
if %timeStamp% GEQ 1200.00 if %timeStamp% LSS 1230.00 goto Msg04
if %timeStamp% GEQ 1230.00 if %timeStamp% LSS 1300.00 goto Msg05
if %timeStamp% GEQ 1300.00 if %timeStamp% LSS 1330.00 goto Msg06
if %timeStamp% GEQ 1330.00 if %timeStamp% LSS 1400.00 goto Msg07
if %timeStamp% GEQ 1400.00 if %timeStamp% LSS 1415.00 goto Msg08
if %timeStamp% GEQ 1415.00 if %timeStamp% LSS 1420.00 goto Msg09
if %timeStamp% GEQ 1420.00 if %timeStamp% LSS 1425.00 goto Msg10
if %timeStamp% GEQ 1425.00 if %timeStamp% LSS 1426.00 goto Msg11
if %timeStamp% GEQ 1426.00 if %timeStamp% LSS 1427.00 goto Msg12
if %timeStamp% GEQ 1427.00 if %timeStamp% LSS 1428.00 goto Msg13
if %timeStamp% GEQ 1428.00 if %timeStamp% LSS 1429.00 goto Msg14
if %timeStamp% GEQ 1429.00 if %timeStamp% LSS 1429.30 goto Msg15
if %timeStamp% GEQ 1429.30 if %timeStamp% LSS 1429.45 goto Msg16
if %timeStamp% GEQ 1429.45 if %timeStamp% LSS 1429.50 goto Msg17
if %timeStamp% GEQ 1429.50 if %timeStamp% LSS 1429.55 goto Msg18
if %timeStamp% GEQ 1429.55 if %timeStamp% LSS 1435.00 goto Msg19
:: 1205 - 1600
if %timeStamp% GEQ 1435.00 if %timeStamp% LSS 1500.00 goto Msg01
if %timeStamp% GEQ 1500.00 if %timeStamp% LSS 1530.00 goto Msg02
if %timeStamp% GEQ 1530.00 if %timeStamp% LSS 1600.00 goto Msg03
if %timeStamp% GEQ 1600.00 if %timeStamp% LSS 1630.00 goto Msg04
if %timeStamp% GEQ 1630.00 if %timeStamp% LSS 1700.00 goto Msg05
if %timeStamp% GEQ 1700.00 if %timeStamp% LSS 1730.00 goto Msg06
if %timeStamp% GEQ 1730.00 if %timeStamp% LSS 1800.00 goto Msg07
if %timeStamp% GEQ 1800.00 if %timeStamp% LSS 1815.00 goto Msg08
if %timeStamp% GEQ 1815.00 if %timeStamp% LSS 1820.00 goto Msg09
if %timeStamp% GEQ 1820.00 if %timeStamp% LSS 1825.00 goto Msg10
if %timeStamp% GEQ 1825.00 if %timeStamp% LSS 1826.00 goto Msg11
if %timeStamp% GEQ 1826.00 if %timeStamp% LSS 1827.00 goto Msg12
if %timeStamp% GEQ 1827.00 if %timeStamp% LSS 1828.00 goto Msg13
if %timeStamp% GEQ 1828.00 if %timeStamp% LSS 1829.00 goto Msg14
if %timeStamp% GEQ 1829.00 if %timeStamp% LSS 1829.30 goto Msg15
if %timeStamp% GEQ 1829.30 if %timeStamp% LSS 1829.45 goto Msg16
if %timeStamp% GEQ 1829.45 if %timeStamp% LSS 1829.50 goto Msg17
if %timeStamp% GEQ 1829.50 if %timeStamp% LSS 1829.55 goto Msg18
if %timeStamp% GEQ 1829.55 if %timeStamp% LSS 1835.00 goto Msg19
:: 1605 - 2000
if %timeStamp% GEQ 1835.00 if %timeStamp% LSS 1900.00 goto Msg01
if %timeStamp% GEQ 1900.00 if %timeStamp% LSS 1930.00 goto Msg02
if %timeStamp% GEQ 1930.00 if %timeStamp% LSS 2000.00 goto Msg03
if %timeStamp% GEQ 2000.00 if %timeStamp% LSS 2030.00 goto Msg04
if %timeStamp% GEQ 2030.00 if %timeStamp% LSS 2100.00 goto Msg05
if %timeStamp% GEQ 2100.00 if %timeStamp% LSS 2130.00 goto Msg06
if %timeStamp% GEQ 2130.00 if %timeStamp% LSS 2200.00 goto Msg07
if %timeStamp% GEQ 2200.00 if %timeStamp% LSS 2215.00 goto Msg08
if %timeStamp% GEQ 2215.00 if %timeStamp% LSS 2220.00 goto Msg09
if %timeStamp% GEQ 2220.00 if %timeStamp% LSS 2225.00 goto Msg10
if %timeStamp% GEQ 2225.00 if %timeStamp% LSS 2226.00 goto Msg11
if %timeStamp% GEQ 2226.00 if %timeStamp% LSS 2227.00 goto Msg12
if %timeStamp% GEQ 2227.00 if %timeStamp% LSS 2228.00 goto Msg13
if %timeStamp% GEQ 2228.00 if %timeStamp% LSS 2229.00 goto Msg14
if %timeStamp% GEQ 2229.00 if %timeStamp% LSS 2229.30 goto Msg15
if %timeStamp% GEQ 2229.30 if %timeStamp% LSS 2229.45 goto Msg16
if %timeStamp% GEQ 2229.45 if %timeStamp% LSS 2229.50 goto Msg17
if %timeStamp% GEQ 2229.50 if %timeStamp% LSS 2229.55 goto Msg18
if %timeStamp% GEQ 2229.55 if %timeStamp% LSS 2235.00 goto Msg19
:: 2005 - 0000
if %timeStamp% GEQ 2235.00 if %timeStamp% LSS 2300.00 goto Msg01
if %timeStamp% GEQ 2300.00 if %timeStamp% LSS 2330.00 goto Msg02
if %timeStamp% GEQ 2330.00 if %timeStamp% LSS 2400.00 goto Msg03
if %timeStamp% GEQ 0000.01 if %timeStamp% LSS 0030.00 goto Msg04
if %timeStamp% GEQ 0030.00 if %timeStamp% LSS 0100.00 goto Msg05
if %timeStamp% GEQ 0100.00 if %timeStamp% LSS 0130.00 goto Msg06
if %timeStamp% GEQ 0130.00 if %timeStamp% LSS 0200.00 goto Msg07
if %timeStamp% GEQ 0200.00 if %timeStamp% LSS 0215.00 goto Msg08
if %timeStamp% GEQ 0215.00 if %timeStamp% LSS 0220.00 goto Msg09
if %timeStamp% GEQ 0220.00 if %timeStamp% LSS 0225.00 goto Msg10
if %timeStamp% GEQ 0225.00 if %timeStamp% LSS 0226.00 goto Msg11
if %timeStamp% GEQ 0226.00 if %timeStamp% LSS 0227.00 goto Msg12
if %timeStamp% GEQ 0227.00 if %timeStamp% LSS 0228.00 goto Msg13
if %timeStamp% GEQ 0228.00 if %timeStamp% LSS 0229.00 goto Msg14
if %timeStamp% GEQ 0229.00 if %timeStamp% LSS 0229.30 goto Msg15
if %timeStamp% GEQ 0229.30 if %timeStamp% LSS 0229.45 goto Msg16
if %timeStamp% GEQ 0229.45 if %timeStamp% LSS 0229.50 goto Msg17
if %timeStamp% GEQ 0229.50 if %timeStamp% LSS 0229.55 goto Msg18
if %timeStamp% GEQ 0229.55 if %timeStamp% LSS 0235.00 goto Msg19
Goto Start
:://// Server Restart
:ServerRestart
...
timeout /t 5 /nobreak > NUL
%SQL_Path%bin\mysql.exe --user=%SQL_User% --password=%SQL_Pass% --host=%sIP% --port=%SQL_Port% --database=%SQL_Name% --execute="call pMain(25)"
timeout /t 5 /nobreak > NUL
