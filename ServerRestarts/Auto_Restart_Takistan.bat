@echo off
title Auto_Server_Restart_Takistan
...
:: 0005 - 0400
if %timeStamp% GEQ 0305.00 if %timeStamp% LSS 0330.00 goto Msg01
if %timeStamp% GEQ 0330.00 if %timeStamp% LSS 0400.00 goto Msg02
if %timeStamp% GEQ 0400.00 if %timeStamp% LSS 0430.00 goto Msg03
if %timeStamp% GEQ 0430.00 if %timeStamp% LSS 0500.00 goto Msg04
if %timeStamp% GEQ 0500.00 if %timeStamp% LSS 0530.00 goto Msg05
if %timeStamp% GEQ 0530.00 if %timeStamp% LSS 0600.00 goto Msg06
if %timeStamp% GEQ 0600.00 if %timeStamp% LSS 0630.00 goto Msg07
if %timeStamp% GEQ 0630.00 if %timeStamp% LSS 0645.00 goto Msg08
if %timeStamp% GEQ 0645.00 if %timeStamp% LSS 0650.00 goto Msg09
if %timeStamp% GEQ 0650.00 if %timeStamp% LSS 0655.00 goto Msg10
if %timeStamp% GEQ 0655.00 if %timeStamp% LSS 0656.00 goto Msg11
if %timeStamp% GEQ 0656.00 if %timeStamp% LSS 0657.00 goto Msg12
if %timeStamp% GEQ 0657.00 if %timeStamp% LSS 0658.00 goto Msg13
if %timeStamp% GEQ 0658.00 if %timeStamp% LSS 0659.00 goto Msg14
if %timeStamp% GEQ 0659.00 if %timeStamp% LSS 0659.30 goto Msg15
if %timeStamp% GEQ 0659.30 if %timeStamp% LSS 0659.45 goto Msg16
if %timeStamp% GEQ 0659.45 if %timeStamp% LSS 0659.50 goto Msg17
if %timeStamp% GEQ 0659.50 if %timeStamp% LSS 0659.55 goto Msg18
if %timeStamp% GEQ 0659.55 if %timeStamp% LSS 0705.00 goto Msg19
:: 0405 - 0800
if %timeStamp% GEQ 0705.00 if %timeStamp% LSS 0730.00 goto Msg01
if %timeStamp% GEQ 0730.00 if %timeStamp% LSS 0800.00 goto Msg02
if %timeStamp% GEQ 0800.00 if %timeStamp% LSS 0830.00 goto Msg03
if %timeStamp% GEQ 0830.00 if %timeStamp% LSS 0900.00 goto Msg04
if %timeStamp% GEQ 0900.00 if %timeStamp% LSS 0930.00 goto Msg05
if %timeStamp% GEQ 0930.00 if %timeStamp% LSS 1000.00 goto Msg06
if %timeStamp% GEQ 1000.00 if %timeStamp% LSS 1030.00 goto Msg07
if %timeStamp% GEQ 1030.00 if %timeStamp% LSS 1045.00 goto Msg08
if %timeStamp% GEQ 1045.00 if %timeStamp% LSS 1050.00 goto Msg09
if %timeStamp% GEQ 1050.00 if %timeStamp% LSS 1055.00 goto Msg10
if %timeStamp% GEQ 1055.00 if %timeStamp% LSS 1056.00 goto Msg11
if %timeStamp% GEQ 1056.00 if %timeStamp% LSS 1057.00 goto Msg12
if %timeStamp% GEQ 1057.00 if %timeStamp% LSS 1058.00 goto Msg13
if %timeStamp% GEQ 1058.00 if %timeStamp% LSS 1059.00 goto Msg14
if %timeStamp% GEQ 1059.00 if %timeStamp% LSS 1059.30 goto Msg15
if %timeStamp% GEQ 1059.30 if %timeStamp% LSS 1059.45 goto Msg16
if %timeStamp% GEQ 1059.45 if %timeStamp% LSS 1059.50 goto Msg17
if %timeStamp% GEQ 1059.50 if %timeStamp% LSS 1059.55 goto Msg18
if %timeStamp% GEQ 1059.55 if %timeStamp% LSS 1105.00 goto Msg19
:: 0805 - 1200
if %timeStamp% GEQ 1105.00 if %timeStamp% LSS 1130.00 goto Msg01
if %timeStamp% GEQ 1130.00 if %timeStamp% LSS 1200.00 goto Msg02
if %timeStamp% GEQ 1200.00 if %timeStamp% LSS 1230.00 goto Msg03
if %timeStamp% GEQ 1230.00 if %timeStamp% LSS 1300.00 goto Msg04
if %timeStamp% GEQ 1300.00 if %timeStamp% LSS 1330.00 goto Msg05
if %timeStamp% GEQ 1330.00 if %timeStamp% LSS 1400.00 goto Msg06
if %timeStamp% GEQ 1400.00 if %timeStamp% LSS 1430.00 goto Msg07
if %timeStamp% GEQ 1430.00 if %timeStamp% LSS 1445.00 goto Msg08
if %timeStamp% GEQ 1445.00 if %timeStamp% LSS 1450.00 goto Msg09
if %timeStamp% GEQ 1450.00 if %timeStamp% LSS 1455.00 goto Msg10
if %timeStamp% GEQ 1455.00 if %timeStamp% LSS 1456.00 goto Msg11
if %timeStamp% GEQ 1456.00 if %timeStamp% LSS 1457.00 goto Msg12
if %timeStamp% GEQ 1457.00 if %timeStamp% LSS 1458.00 goto Msg13
if %timeStamp% GEQ 1458.00 if %timeStamp% LSS 1459.00 goto Msg14
if %timeStamp% GEQ 1459.00 if %timeStamp% LSS 1459.30 goto Msg15
if %timeStamp% GEQ 1459.30 if %timeStamp% LSS 1459.45 goto Msg16
if %timeStamp% GEQ 1459.45 if %timeStamp% LSS 1459.50 goto Msg17
if %timeStamp% GEQ 1459.50 if %timeStamp% LSS 1459.55 goto Msg18
if %timeStamp% GEQ 1459.55 if %timeStamp% LSS 1505.00 goto Msg19
:: 1205 - 1600
if %timeStamp% GEQ 1505.00 if %timeStamp% LSS 1530.00 goto Msg01
if %timeStamp% GEQ 1530.00 if %timeStamp% LSS 1600.00 goto Msg02
if %timeStamp% GEQ 1600.00 if %timeStamp% LSS 1630.00 goto Msg03
if %timeStamp% GEQ 1630.00 if %timeStamp% LSS 1700.00 goto Msg04
if %timeStamp% GEQ 1700.00 if %timeStamp% LSS 1730.00 goto Msg05
if %timeStamp% GEQ 1730.00 if %timeStamp% LSS 1800.00 goto Msg06
if %timeStamp% GEQ 1800.00 if %timeStamp% LSS 1830.00 goto Msg07
if %timeStamp% GEQ 1830.00 if %timeStamp% LSS 1845.00 goto Msg08
if %timeStamp% GEQ 1845.00 if %timeStamp% LSS 1850.00 goto Msg09
if %timeStamp% GEQ 1850.00 if %timeStamp% LSS 1855.00 goto Msg10
if %timeStamp% GEQ 1855.00 if %timeStamp% LSS 1856.00 goto Msg11
if %timeStamp% GEQ 1856.00 if %timeStamp% LSS 1857.00 goto Msg12
if %timeStamp% GEQ 1857.00 if %timeStamp% LSS 1858.00 goto Msg13
if %timeStamp% GEQ 1858.00 if %timeStamp% LSS 1859.00 goto Msg14
if %timeStamp% GEQ 1859.00 if %timeStamp% LSS 1859.30 goto Msg15
if %timeStamp% GEQ 1859.30 if %timeStamp% LSS 1859.45 goto Msg16
if %timeStamp% GEQ 1859.45 if %timeStamp% LSS 1859.50 goto Msg17
if %timeStamp% GEQ 1859.50 if %timeStamp% LSS 1859.55 goto Msg18
if %timeStamp% GEQ 1859.55 if %timeStamp% LSS 1905.00 goto Msg19
:: 1605 - 2000
if %timeStamp% GEQ 1905.00 if %timeStamp% LSS 1930.00 goto Msg01
if %timeStamp% GEQ 1930.00 if %timeStamp% LSS 2000.00 goto Msg02
if %timeStamp% GEQ 2000.00 if %timeStamp% LSS 2030.00 goto Msg03
if %timeStamp% GEQ 2030.00 if %timeStamp% LSS 2100.00 goto Msg04
if %timeStamp% GEQ 2100.00 if %timeStamp% LSS 2130.00 goto Msg05
if %timeStamp% GEQ 2130.00 if %timeStamp% LSS 2200.00 goto Msg06
if %timeStamp% GEQ 2200.00 if %timeStamp% LSS 2230.00 goto Msg07
if %timeStamp% GEQ 2230.00 if %timeStamp% LSS 2245.00 goto Msg08
if %timeStamp% GEQ 2245.00 if %timeStamp% LSS 2250.00 goto Msg09
if %timeStamp% GEQ 2250.00 if %timeStamp% LSS 2255.00 goto Msg10
if %timeStamp% GEQ 2255.00 if %timeStamp% LSS 2256.00 goto Msg11
if %timeStamp% GEQ 2256.00 if %timeStamp% LSS 2257.00 goto Msg12
if %timeStamp% GEQ 2257.00 if %timeStamp% LSS 2258.00 goto Msg13
if %timeStamp% GEQ 2258.00 if %timeStamp% LSS 2259.00 goto Msg14
if %timeStamp% GEQ 2259.00 if %timeStamp% LSS 2259.30 goto Msg15
if %timeStamp% GEQ 2259.30 if %timeStamp% LSS 2259.45 goto Msg16
if %timeStamp% GEQ 2259.45 if %timeStamp% LSS 2259.50 goto Msg17
if %timeStamp% GEQ 2259.50 if %timeStamp% LSS 2259.55 goto Msg18
if %timeStamp% GEQ 2259.55 if %timeStamp% LSS 2305.00 goto Msg19
:: 2005 - 0000
if %timeStamp% GEQ 2305.00 if %timeStamp% LSS 2330.00 goto Msg01
if %timeStamp% GEQ 2330.00 if %timeStamp% LSS 2400.00 goto Msg02
if %timeStamp% GEQ 0000.01 if %timeStamp% LSS 0030.00 goto Msg03
if %timeStamp% GEQ 0030.00 if %timeStamp% LSS 0100.00 goto Msg04
if %timeStamp% GEQ 0100.00 if %timeStamp% LSS 0130.00 goto Msg05
if %timeStamp% GEQ 0130.00 if %timeStamp% LSS 0200.00 goto Msg06
if %timeStamp% GEQ 0200.00 if %timeStamp% LSS 0230.00 goto Msg07
if %timeStamp% GEQ 0230.00 if %timeStamp% LSS 0245.00 goto Msg08
if %timeStamp% GEQ 0245.00 if %timeStamp% LSS 0250.00 goto Msg09
if %timeStamp% GEQ 0250.00 if %timeStamp% LSS 0255.00 goto Msg10
if %timeStamp% GEQ 0255.00 if %timeStamp% LSS 0256.00 goto Msg11
if %timeStamp% GEQ 0256.00 if %timeStamp% LSS 0257.00 goto Msg12
if %timeStamp% GEQ 0257.00 if %timeStamp% LSS 0258.00 goto Msg13
if %timeStamp% GEQ 0258.00 if %timeStamp% LSS 0259.00 goto Msg14
if %timeStamp% GEQ 0259.00 if %timeStamp% LSS 0259.30 goto Msg15
if %timeStamp% GEQ 0259.30 if %timeStamp% LSS 0259.45 goto Msg16
if %timeStamp% GEQ 0259.45 if %timeStamp% LSS 0259.50 goto Msg17
if %timeStamp% GEQ 0259.50 if %timeStamp% LSS 0259.55 goto Msg18
if %timeStamp% GEQ 0259.55 if %timeStamp% LSS 0305.00 goto Msg19
Goto Start
:://// Server Restart
:ServerRestart
...
timeout /t 5 /nobreak > NUL
%SQL_Path%bin\mysql.exe --user=%SQL_User% --password=%SQL_Pass% --host=%sIP% --port=%SQL_Port% --database=%SQL_Name% --execute="call pMain(1)"
timeout /t 5 /nobreak > NUL
