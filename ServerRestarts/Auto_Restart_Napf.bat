@echo off
title Auto_Server_Restart_Napf
...
:: 0005 - 0400
if %timeStamp% GEQ 0205.00 if %timeStamp% LSS 0230.00 goto Msg01
if %timeStamp% GEQ 0230.00 if %timeStamp% LSS 0300.00 goto Msg02
if %timeStamp% GEQ 0300.00 if %timeStamp% LSS 0330.00 goto Msg03
if %timeStamp% GEQ 0330.00 if %timeStamp% LSS 0400.00 goto Msg04
if %timeStamp% GEQ 0400.00 if %timeStamp% LSS 0430.00 goto Msg05
if %timeStamp% GEQ 0430.00 if %timeStamp% LSS 0500.00 goto Msg06
if %timeStamp% GEQ 0500.00 if %timeStamp% LSS 0530.00 goto Msg07
if %timeStamp% GEQ 0530.00 if %timeStamp% LSS 0545.00 goto Msg08
if %timeStamp% GEQ 0545.00 if %timeStamp% LSS 0550.00 goto Msg09
if %timeStamp% GEQ 0550.00 if %timeStamp% LSS 0555.00 goto Msg10
if %timeStamp% GEQ 0555.00 if %timeStamp% LSS 0556.00 goto Msg11
if %timeStamp% GEQ 0556.00 if %timeStamp% LSS 0557.00 goto Msg12
if %timeStamp% GEQ 0557.00 if %timeStamp% LSS 0558.00 goto Msg13
if %timeStamp% GEQ 0558.00 if %timeStamp% LSS 0559.00 goto Msg14
if %timeStamp% GEQ 0559.00 if %timeStamp% LSS 0559.30 goto Msg15
if %timeStamp% GEQ 0559.30 if %timeStamp% LSS 0559.45 goto Msg16
if %timeStamp% GEQ 0559.45 if %timeStamp% LSS 0559.50 goto Msg17
if %timeStamp% GEQ 0559.50 if %timeStamp% LSS 0559.55 goto Msg18
if %timeStamp% GEQ 0559.55 if %timeStamp% LSS 0605.00 goto Msg19
:: 0405 - 0800
if %timeStamp% GEQ 0605.00 if %timeStamp% LSS 0630.00 goto Msg01
if %timeStamp% GEQ 0630.00 if %timeStamp% LSS 0700.00 goto Msg02
if %timeStamp% GEQ 0700.00 if %timeStamp% LSS 0730.00 goto Msg03
if %timeStamp% GEQ 0730.00 if %timeStamp% LSS 0800.00 goto Msg04
if %timeStamp% GEQ 0800.00 if %timeStamp% LSS 0830.00 goto Msg05
if %timeStamp% GEQ 0830.00 if %timeStamp% LSS 0900.00 goto Msg06
if %timeStamp% GEQ 0900.00 if %timeStamp% LSS 0930.00 goto Msg07
if %timeStamp% GEQ 0930.00 if %timeStamp% LSS 0945.00 goto Msg08
if %timeStamp% GEQ 0945.00 if %timeStamp% LSS 0950.00 goto Msg09
if %timeStamp% GEQ 0950.00 if %timeStamp% LSS 0955.00 goto Msg10
if %timeStamp% GEQ 0955.00 if %timeStamp% LSS 0956.00 goto Msg11
if %timeStamp% GEQ 0956.00 if %timeStamp% LSS 0957.00 goto Msg12
if %timeStamp% GEQ 0957.00 if %timeStamp% LSS 0958.00 goto Msg13
if %timeStamp% GEQ 0958.00 if %timeStamp% LSS 0959.00 goto Msg14
if %timeStamp% GEQ 0959.00 if %timeStamp% LSS 0959.30 goto Msg15
if %timeStamp% GEQ 0959.30 if %timeStamp% LSS 0959.45 goto Msg16
if %timeStamp% GEQ 0959.45 if %timeStamp% LSS 0959.50 goto Msg17
if %timeStamp% GEQ 0959.50 if %timeStamp% LSS 0959.55 goto Msg18
if %timeStamp% GEQ 0959.55 if %timeStamp% LSS 1005.00 goto Msg19
:: 0805 - 1200
if %timeStamp% GEQ 1005.00 if %timeStamp% LSS 1030.00 goto Msg01
if %timeStamp% GEQ 1030.00 if %timeStamp% LSS 1100.00 goto Msg02
if %timeStamp% GEQ 1100.00 if %timeStamp% LSS 1130.00 goto Msg03
if %timeStamp% GEQ 1130.00 if %timeStamp% LSS 1200.00 goto Msg04
if %timeStamp% GEQ 1200.00 if %timeStamp% LSS 1230.00 goto Msg05
if %timeStamp% GEQ 1230.00 if %timeStamp% LSS 1300.00 goto Msg06
if %timeStamp% GEQ 1300.00 if %timeStamp% LSS 1330.00 goto Msg07
if %timeStamp% GEQ 1330.00 if %timeStamp% LSS 1345.00 goto Msg08
if %timeStamp% GEQ 1345.00 if %timeStamp% LSS 1350.00 goto Msg09
if %timeStamp% GEQ 1350.00 if %timeStamp% LSS 1355.00 goto Msg10
if %timeStamp% GEQ 1355.00 if %timeStamp% LSS 1356.00 goto Msg11
if %timeStamp% GEQ 1356.00 if %timeStamp% LSS 1357.00 goto Msg12
if %timeStamp% GEQ 1357.00 if %timeStamp% LSS 1358.00 goto Msg13
if %timeStamp% GEQ 1358.00 if %timeStamp% LSS 1359.00 goto Msg14
if %timeStamp% GEQ 1359.00 if %timeStamp% LSS 1359.30 goto Msg15
if %timeStamp% GEQ 1359.30 if %timeStamp% LSS 1359.45 goto Msg16
if %timeStamp% GEQ 1359.45 if %timeStamp% LSS 1359.50 goto Msg17
if %timeStamp% GEQ 1359.50 if %timeStamp% LSS 1359.55 goto Msg18
if %timeStamp% GEQ 1359.55 if %timeStamp% LSS 1405.00 goto Msg19
:: 1205 - 1600
if %timeStamp% GEQ 1405.00 if %timeStamp% LSS 1430.00 goto Msg01
if %timeStamp% GEQ 1430.00 if %timeStamp% LSS 1500.00 goto Msg02
if %timeStamp% GEQ 1500.00 if %timeStamp% LSS 1530.00 goto Msg03
if %timeStamp% GEQ 1530.00 if %timeStamp% LSS 1600.00 goto Msg04
if %timeStamp% GEQ 1600.00 if %timeStamp% LSS 1630.00 goto Msg05
if %timeStamp% GEQ 1630.00 if %timeStamp% LSS 1700.00 goto Msg06
if %timeStamp% GEQ 1700.00 if %timeStamp% LSS 1730.00 goto Msg07
if %timeStamp% GEQ 1730.00 if %timeStamp% LSS 1745.00 goto Msg08
if %timeStamp% GEQ 1745.00 if %timeStamp% LSS 1750.00 goto Msg09
if %timeStamp% GEQ 1750.00 if %timeStamp% LSS 1755.00 goto Msg10
if %timeStamp% GEQ 1755.00 if %timeStamp% LSS 1756.00 goto Msg11
if %timeStamp% GEQ 1756.00 if %timeStamp% LSS 1757.00 goto Msg12
if %timeStamp% GEQ 1757.00 if %timeStamp% LSS 1758.00 goto Msg13
if %timeStamp% GEQ 1758.00 if %timeStamp% LSS 1759.00 goto Msg14
if %timeStamp% GEQ 1759.00 if %timeStamp% LSS 1759.30 goto Msg15
if %timeStamp% GEQ 1759.30 if %timeStamp% LSS 1759.45 goto Msg16
if %timeStamp% GEQ 1759.45 if %timeStamp% LSS 1759.50 goto Msg17
if %timeStamp% GEQ 1759.50 if %timeStamp% LSS 1759.55 goto Msg18
if %timeStamp% GEQ 1759.55 if %timeStamp% LSS 1805.00 goto Msg19
:: 1605 - 2000
if %timeStamp% GEQ 1805.00 if %timeStamp% LSS 1830.00 goto Msg01
if %timeStamp% GEQ 1830.00 if %timeStamp% LSS 1900.00 goto Msg02
if %timeStamp% GEQ 1900.00 if %timeStamp% LSS 1930.00 goto Msg03
if %timeStamp% GEQ 1930.00 if %timeStamp% LSS 2000.00 goto Msg04
if %timeStamp% GEQ 2000.00 if %timeStamp% LSS 2030.00 goto Msg05
if %timeStamp% GEQ 2030.00 if %timeStamp% LSS 2100.00 goto Msg06
if %timeStamp% GEQ 2100.00 if %timeStamp% LSS 2130.00 goto Msg07
if %timeStamp% GEQ 2130.00 if %timeStamp% LSS 2145.00 goto Msg08
if %timeStamp% GEQ 2145.00 if %timeStamp% LSS 2150.00 goto Msg09
if %timeStamp% GEQ 2150.00 if %timeStamp% LSS 2155.00 goto Msg10
if %timeStamp% GEQ 2155.00 if %timeStamp% LSS 2156.00 goto Msg11
if %timeStamp% GEQ 2156.00 if %timeStamp% LSS 2157.00 goto Msg12
if %timeStamp% GEQ 2157.00 if %timeStamp% LSS 2158.00 goto Msg13
if %timeStamp% GEQ 2158.00 if %timeStamp% LSS 2159.00 goto Msg14
if %timeStamp% GEQ 2159.00 if %timeStamp% LSS 2159.30 goto Msg15
if %timeStamp% GEQ 2159.30 if %timeStamp% LSS 2159.45 goto Msg16
if %timeStamp% GEQ 2159.45 if %timeStamp% LSS 2159.50 goto Msg17
if %timeStamp% GEQ 2159.50 if %timeStamp% LSS 2159.55 goto Msg18
if %timeStamp% GEQ 2159.55 if %timeStamp% LSS 2205.00 goto Msg19
:: 2005 - 0000
if %timeStamp% GEQ 2205.00 if %timeStamp% LSS 2230.00 goto Msg01
if %timeStamp% GEQ 2230.00 if %timeStamp% LSS 2300.00 goto Msg02
if %timeStamp% GEQ 2300.00 if %timeStamp% LSS 2330.00 goto Msg03
if %timeStamp% GEQ 2330.00 if %timeStamp% LSS 2400.00 goto Msg04
if %timeStamp% GEQ 0000.01 if %timeStamp% LSS 0030.00 goto Msg05
if %timeStamp% GEQ 0030.00 if %timeStamp% LSS 0100.00 goto Msg06
if %timeStamp% GEQ 0100.00 if %timeStamp% LSS 0130.00 goto Msg07
if %timeStamp% GEQ 0130.00 if %timeStamp% LSS 0145.00 goto Msg08
if %timeStamp% GEQ 0145.00 if %timeStamp% LSS 0150.00 goto Msg09
if %timeStamp% GEQ 0150.00 if %timeStamp% LSS 0155.00 goto Msg10
if %timeStamp% GEQ 0155.00 if %timeStamp% LSS 0156.00 goto Msg11
if %timeStamp% GEQ 0156.00 if %timeStamp% LSS 0157.00 goto Msg12
if %timeStamp% GEQ 0157.00 if %timeStamp% LSS 0158.00 goto Msg13
if %timeStamp% GEQ 0158.00 if %timeStamp% LSS 0159.00 goto Msg14
if %timeStamp% GEQ 0159.00 if %timeStamp% LSS 0159.30 goto Msg15
if %timeStamp% GEQ 0159.30 if %timeStamp% LSS 0159.45 goto Msg16
if %timeStamp% GEQ 0159.45 if %timeStamp% LSS 0159.50 goto Msg17
if %timeStamp% GEQ 0159.50 if %timeStamp% LSS 0159.55 goto Msg18
if %timeStamp% GEQ 0159.55 if %timeStamp% LSS 0205.00 goto Msg19
Goto Start
:://// Server Restart
:ServerRestart
...
timeout /t 5 /nobreak > NUL
%SQL_Path%bin\mysql.exe --user=%SQL_User% --password=%SQL_Pass% --host=%sIP% --port=%SQL_Port% --database=%SQL_Name% --execute="call pMain(24)"
timeout /t 5 /nobreak > NUL
