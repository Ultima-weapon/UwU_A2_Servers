...
_infiSZ =
[
        [[6013.0737,6629.2124,0],30,true],	// Rommelo's Raceway
        [[6545.7944,6867.1309,0],30,true],	// Axles Repair Shop
        [[7033.144,7103.0996,0],30,true],	// AWOL's Planes
        [[3059.0198,8021.9331,0],30,true],	// Wholesaler Blivion
        [[3610.2993,3686.4067,0],30,true],	// Jim and Joe's Weapons/Ammo
        [[4250.3955,4481.9404,0],30,true],	// Whiskey's Parts
        [[4143.9258,1481.0282,0],30,true],	// Chip's Choppers
		[[7551.1641,3025.2014,0],30,true],	// Used Cars
		[[7509.8115,2951.6182,0],30,true],	// Chuck and Buck's Weapons/Ammo
		[[3008.9712,5932.8613,0],50,true],	// Green's Quality Cars
		[[894.12573,5270.0874,0],30,true],	// Alejandria and Melly's Medica/Survival Shop
		[[8348.2188,8739.2813,0],30,true],	// Wholesaler Clive
		[[4181.9175,2341.8435,0],30,true],	// Bag lady Gina
		[[719.30035,1576.938,0],30,true],	// Wholesaler Santos
		[[1730.6815,4139.9688,0],30,true],	// Adventure 4x4
		[[2378.4463,4118.7832,0],30,true],	// MotoDrom 4x4 Offroad
		[[3925.5791,5225.2319,0],30,true],	// Big Bob's Boats
		[[5509.2041,4392.7847,0],30,true],	// Juan's Tour Boats
		[[3879.7634,2236.843,0],30,true],	// Jd's Armed boats
		[[6676.3252,6361.1772,0],30,true],	// Stella's Stop
		[[4236.6968,4842.8164,0],30,true],	// Samish Shop
		[[6678.1494,4294.6987,0],30,true],	// Mad Scientist
		[[4099.8921,9243.417,0],30,true],	// Bandit Trader
		[[4144.0195,1478.6262,0],75,true]	// Hero Trader
];
