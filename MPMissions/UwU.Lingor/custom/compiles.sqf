...
if (!isDedicated) then {
	...
	garage_getnearVeh = 			compile preprocessFileLineNumbers "custom\addons\Garage\garage_nearvehicles.sqf";
	garage_getstoredVeh = 			compile preprocessFileLineNumbers "custom\addons\Garage\garage_storedvehicles.sqf";
	garage_manage = 				compile preprocessFileLineNumbers "custom\addons\Garage\garage_manage.sqf";
	garage_fillplayers = 			compile preprocessFileLineNumbers "custom\addons\Garage\garage_fillplayers.sqf";
	garage_addfriend = 				compile preprocessFileLineNumbers "custom\addons\Garage\garage_addfriend.sqf";
	garage_removefriend = 			compile preprocessFileLineNumbers "custom\addons\Garage\garage_removefriend.sqf";
	garage_spawnVehicle = 			compile preprocessFileLineNumbers "custom\addons\Garage\garage_spawnvehicle.sqf";
	garage_storeVehicle = 			compile preprocessFileLineNumbers "custom\addons\Garage\garage_storeVehicle.sqf";
	
	VehicleColourPaint =			compile preprocessFileLineNumbers "custom\addons\Paint\vehicleColourPaint.sqf";
	VehicleColourUpdate =			compile preprocessFileLineNumbers "custom\addons\Paint\VehicleColourUpdate.sqf";
	VehicleColourUpdate2 =			compile preprocessFileLineNumbers "custom\addons\Paint\VehicleColourUpdate2.sqf";
	player_paint =					compile preprocessFileLineNumbers "custom\addons\Paint\player_paint.sqf";
	
	BIS_Effects_Burn = 				compile preprocessFile "\ca\Data\ParticleEffects\SCRIPTS\destruction\burn.sqf";
	player_zombieCheck = 			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_zombieCheck.sqf";		//Run on a players computer, checks if the player is near a zombie
	player_zombieAttack = 			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_zombieAttack.sqf";	//Run on a players computer, causes a nearby zombie to attack them
	fnc_usec_damageActions =		compile preprocessFileLineNumbers "custom\Compile\fn_damageActions.sqf";					//Checks which actions for nearby casualty
	...
	player_dumpBackpack = 			compile preprocessFileLineNumbers "custom\compile\player_dumpBackpack.sqf";
	...
	player_packTent =				compile preprocessFileLineNumbers "custom\compile\player_packTent.sqf";
	player_packVault =				compile preprocessFileLineNumbers "custom\compile\player_packVault.sqf";
	...
	fn_gearMenuChecks =			compile preprocessFileLineNumbers "custom\compile\fn_gearMenuChecks.sqf";
	//Objects
	...
	zombie_generate = 			compile preprocessFileLineNumbers "custom\compile\zombie_generate.sqf";							//Server compile, used for loiter behaviour
	wild_spawnZombies = 		compile preprocessFileLineNumbers "custom\compile\wild_spawnZombies.sqf";						//Server compile, used for loiter behaviour
	...
	player_tentPitch =			compile preprocessFileLineNumbers "custom\actions\tent_pitch.sqf";
	player_vaultPitch =			compile preprocessFileLineNumbers "custom\actions\vault_pitch.sqf";
	...
	player_fillWater = 			compile preprocessFileLineNumbers "custom\actions\player_waterfill.sqf";
	player_makeFire =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_makefire.sqf";
	player_harvestPlant =		compile preprocessFileLineNumbers "custom\actions\player_harvestPlant.sqf";
	player_goFishing =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_goFishing.sqf";
	PlotGetFriends = 			compile preprocessFileLineNumbers "custom\actions\plotGetFriends.sqf";
	PlotNearbyHumans = 			compile preprocessFileLineNumbers "custom\actions\plotNearbyHumans.sqf";
	PlotAddFriend = 			compile preprocessFileLineNumbers "custom\actions\plotAddFriend.sqf";
	PlotRemoveFriend = 			compile preprocessFileLineNumbers "custom\actions\plotRemoveFriend.sqf";
	MaintainPlot = 				compile preprocessFileLineNumbers "custom\actions\maintain_area.sqf";
	PlotPreview = 				compile preprocessFileLineNumbers "custom\actions\plotToggleMarkers.sqf";
	PlotObjects = 				compile preprocessFileLineNumbers "custom\actions\plotObjects.sqf";
	DoorGetFriends = 			compile preprocessFileLineNumbers "custom\actions\doorGetFriends.sqf";
	DoorNearbyHumans = 			compile preprocessFileLineNumbers "custom\actions\doorNearbyHumans.sqf";
	DoorAddFriend = 			compile preprocessFileLineNumbers "custom\actions\doorAddFriend.sqf";
	DoorRemoveFriend = 			compile preprocessFileLineNumbers "custom\actions\doorRemoveFriend.sqf";
	player_unlockDoor = 		compile preprocessFileLineNumbers "custom\actions\player_unlockDoor.sqf";
	player_unlockDoorCode = 	compile preprocessFileLineNumbers "custom\actions\player_unlockDoorCode.sqf";
	player_manageDoor = 		compile preprocessFileLineNumbers "custom\actions\initDoorManagement.sqf";
	player_enterCode = 			compile preprocessFileLineNumbers "custom\actions\player_enterCode.sqf";
	player_changeCombo = 		compile preprocessFileLineNumbers "custom\actions\player_changeCombo.sqf"; 
	player_build =				compile preprocessFileLineNumbers "custom\actions\modular_build.sqf";
	player_build_countNearby =	compile preprocessFileLineNumbers "custom\actions\player_build_countNearby.sqf";
	player_build_states =		compile preprocessFileLineNumbers "custom\actions\player_build_states.sqf";
	player_build_needNearby =	compile preprocessFileLineNumbers "custom\actions\player_build_needNearby.sqf";
	player_build_getConfig =	compile preprocessFileLineNumbers "custom\actions\player_build_getConfig.sqf";
	player_build_plotCheck =	compile preprocessFileLineNumbers "custom\actions\player_build_plotCheck.sqf";
	player_build_buildReq =		compile preprocessFileLineNumbers "custom\actions\player_build_buildReq.sqf";
	player_build_create =		compile preprocessFileLineNumbers "custom\actions\player_build_create.sqf";
	player_build_controls =		compile preprocessFileLineNumbers "custom\actions\player_build_controls.sqf";
	player_build_publish =		compile preprocessFileLineNumbers "custom\actions\player_build_publish.sqf";
	DZE_snap_build_file = 		"custom\actions\snap_build.sqf"; 																// Set as a global variable as it is also referenced in snapbuild.sqf
	snap_build = 				compile preprocessFileLineNumbers DZE_snap_build_file;
	FNC_check_owner =			compile preprocessFileLineNumbers "custom\compile\fn_check_owner.sqf";
	FNC_find_plots =			compile preprocessFileLineNumbers "custom\compile\fn_find_plots.sqf";
	fnc_SetPitchBankYaw =       compile preprocessFileLineNumbers "custom\compile\fnc_SetPitchBankYaw.sqf";
	DZE_build_vector_file = 	"custom\compile\build_vectors.sqf";
	build_vectors = 			compile preprocessFileLineNumbers DZE_build_vector_file;
	FillSkinList = 				compile preprocessFileLineNumbers "custom\compile\getList.sqf";
	ApplySkinList = 			compile preprocessFileLineNumbers "custom\compile\changeClothes.sqf";
	player_wearClothes =		compile preprocessFileLineNumbers "custom\actions\player_wearClothes.sqf";
	object_pickup = 			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\object_pickup.sqf";
	player_flipvehicle = 		compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_flipvehicle.sqf";
	player_sleep = 				compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_sleep.sqf";
	player_antiWall =			compile preprocessFileLineNumbers "custom\compile\player_antiWall.sqf";
	player_deathBoard =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\list_playerDeathsAlt.sqf";
	player_plotPreview = 		compile preprocessFileLineNumbers "custom\actions\object_showPlotRadius.sqf";
	player_upgradeVehicle =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_upgradeVehicle.sqf";
	//ui
	player_selectSlot =			compile preprocessFileLineNumbers "custom\compile\ui_selectSlot.sqf";
	...
	if (DZE_ConfigTrader) then {
		...
		call compile preprocessFileLineNumbers "custom\addons\VASP\player_traderMenuHive.sqf";
	};

	// recent murders menu code
	call compile preprocessFileLineNumbers "custom\compile\player_murderMenu.sqf";
	...
	fnc_usec_damageHandler =		compile preprocessFileLineNumbers "custom\compile\fn_damageHandler.sqf";		//Event handler run on damage
	fnc_veh_ResetEH = 			compile preprocessFileLineNumbers "custom\compile\veh_ResetEH.sqf";			//Initialize vehicle
	// Vehicle damage fix
	vehicle_handleDamage    = 		compile preprocessFileLineNumbers "custom\compile\vehicle_handleDamage.sqf";
	vehicle_handleKilled    = 		compile preprocessFileLineNumbers "custom\compile\vehicle_handleKilled.sqf";
	...
	local_lockUnlock =				compile preprocessFileLineNumbers "custom\compile\local_lockUnlock.sqf";		//When vehicle is local to unit perform locking vehicle
	...
	call compile preprocessFileLineNumbers "custom\addons\mbc\config.sqf";
