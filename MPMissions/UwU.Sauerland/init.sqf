...
dayZ_instance = 25; dayz_serverName = "@UwU.Sauerland"; dayzHiveRequest = []; initialized = false; dayz_previousID = 0; player setVariable ["BIS_noCoreConversations", true]; enableRadio false; enableSentences false;
...
if (isServer) then {
	call compile preprocessFileLineNumbers "\z\addons\dayz_server\missions\UwU.sauerland\dynamic_vehicle.sqf";
	_nil = [] execVM "\z\addons\dayz_server\missions\UwU.sauerland\mission.sqf";
