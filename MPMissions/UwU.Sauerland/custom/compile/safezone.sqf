...
_infiSZ =
[
        [[15487.767,17015.457,0],100,true],	// Trader City Seedorf
        [[24713.129,21741.785,0],100,true],	// Trader City Oberberg
        [[11046.387,15669.861,0],100,true],	// Hero Vendor
        [[15350.896,18522.543,0],50,true],	// Axles Airfield
        [[2507.0181,3870.2949,0],50,true],	// South Wholesaler
        [[223.39224,22703.682,0],50,true],	// North Wholesaler
        [[16989.15,1778.1558,0],50,true],	// Bandit Vendor
		[[13176.351,6614.1758,0],100,true]	// Trader city Oberdorf
];
