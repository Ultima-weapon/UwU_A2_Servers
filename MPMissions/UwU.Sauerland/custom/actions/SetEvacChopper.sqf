...
private ["_allNearRescueFields","_locationPlayer","_cnt","_objectID","_objectUID","_targetVehicle","_magazinesPlayer","_hasBriefcase","_location","_dir","_object","_humRank"];

_humRank = player getVariable['humanity', 0];
// NO RANK
if(_humRank < 5000 && _humRank > -5000) then {evac_chopperPrice = 300000;};
// HERO RANK
if(_humRank >= 5000 && _humRank < 10000) then {evac_chopperPrice = 270000;};
if(_humRank >= 10000 && _humRank < 15000) then {evac_chopperPrice = 240000;};
if(_humRank >= 15000 && _humRank < 25000) then {evac_chopperPrice = 210000;};
if(_humRank >= 25000 && _humRank < 40000) then {evac_chopperPrice = 180000;};
if(_humRank >= 40000 && _humRank < 60000) then {evac_chopperPrice = 150000;};
if(_humRank >= 60000 && _humRank < 90000) then {evac_chopperPrice = 120000;};
if(_humRank >= 90000 && _humRank < 130000) then {evac_chopperPrice = 90000;};
if(_humRank >= 130000 && _humRank < 185000) then {evac_chopperPrice = 60000;};
if(_humRank >= 185000 && _humRank < 250000) then {evac_chopperPrice = 30000;};
if(_humRank >= 250000) then {evac_chopperPrice = 0;};
// BANDIT RANK
if(_humRank <= -5000 && _humRank > -10000) then {evac_chopperPrice = 320000;};
if(_humRank <= -10000 && _humRank > -15000) then {evac_chopperPrice = 340000;};
if(_humRank <= -15000 && _humRank > -25000) then {evac_chopperPrice = 360000;};
if(_humRank <= -25000 && _humRank > -40000) then {evac_chopperPrice = 380000;};
if(_humRank <= -40000 && _humRank > -60000) then {evac_chopperPrice = 400000;};
if(_humRank <= -60000 && _humRank > -90000) then {evac_chopperPrice = 420000;};
if(_humRank <= -90000 && _humRank > -130000) then {evac_chopperPrice = 440000;};
if(_humRank <= -130000 && _humRank > -185000) then {evac_chopperPrice = 460000;};
if(_humRank <= -185000 && _humRank > -250000) then {evac_chopperPrice = 480000;};
if(_humRank <= -250000) then {evac_chopperPrice = 500000;};
...
//If not exit script
_hasBriefcase = player getVariable["cashMoney",0];
if (_hasBriefcase < evac_chopperPrice) then {
	systemChat(format["Making an Evac-Chopper costs %1 %2 - You dont have it - Sorry!", evac_chopperPrice, CurrencyName]);
	s_player_makeEvacChopper = -1;
	breakOut "exit";
};
...
if (!([player, evac_chopperPrice] call SC_fnc_removeCoins)) then {
	...
	systemChat(format["Making an Evac-Chopper costs %1 %2 - Thanks for your payment!", evac_chopperPrice, CurrencyName]);
};
