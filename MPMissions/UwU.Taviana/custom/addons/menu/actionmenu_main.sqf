_pathtoscripts = "custom\addons\menu\tools\";
_pathtocolors = "custom\addons\menu\sky\";
_pathtofog = "custom\addons\menu\fog\";
_pathtodonations = "custom\addons\menu\donations\";
_pathtobuilding = "custom\addons\menu\building\";
_pathtoPack = "custom\addons\deployables\";
_pathtoclothing = "custom\addons\menu\wardrobe\";
_pathtoGroup = "custom\addons\dzgm\";
_pathtoAirDrop = "custom\addons\menu\tools\";
_pathtoBloodBag = "custom\actions\";
...
_EXECscript7 = '["%1"] execVM "custom\addons\deployables\deploy.sqf"';
_EXECscript8 = 'player execVM  "'+_pathtoPack+'%1"';
_EXECscript9 = '["%1"] execVM "custom\addons\menu\tools\movements.sqf"';
...
_EXECscript14 = 'player execVM "'+_pathtoBloodBag+'%1"';
...
[
	["",true],
		...
		["Self Bloodbag", [5],  "", -5, [["expression", format[_EXECscript14,"player_selfBloodbag.sqf"]]], "1", "1"],
