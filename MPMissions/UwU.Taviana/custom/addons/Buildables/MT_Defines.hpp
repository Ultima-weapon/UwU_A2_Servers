class Custom_Buildables {
	...
	//119
	class Garages{
	class Land_MBG_Garage_Single_A:DefaultEmerald {};
	class Land_MBG_Garage_Single_B:DefaultEmerald {};
	class Land_MBG_Garage_Single_C:DefaultEmerald {};
	class Land_MBG_Garage_Single_D:DefaultEmerald {};
	};
	class Barrels{				//13
