...
// initiate the functions and variables for advanced trading -- easier for the people :) otherwise it would be in compiles or different file.
	...
	Z_calcPrice = {
		...
		if(Z_Selling)then{	
			...
			// NO RANK
			if(_humRank < 5000 && _humRank > -5000) then {_sellPrice = _sellPrice;};
			// HERO RANK
			if(_humRank >= 5000 && _humRank < 10000) then {_sellPrice = round(_sellPrice*0.95);};
			if(_humRank >= 10000 && _humRank < 15000) then {_sellPrice = round(_sellPrice*0.90);};
			if(_humRank >= 15000 && _humRank < 25000) then {_sellPrice = round(_sellPrice*0.85);};
			if(_humRank >= 25000 && _humRank < 40000) then {_sellPrice = round(_sellPrice*0.80);};
			if(_humRank >= 40000 && _humRank < 60000) then {_sellPrice = round(_sellPrice*0.75);};
			if(_humRank >= 60000 && _humRank < 90000) then {_sellPrice = round(_sellPrice*0.70);};
			if(_humRank >= 90000 && _humRank < 130000) then {_sellPrice = round(_sellPrice*0.65);};
			if(_humRank >= 130000 && _humRank < 185000) then {_sellPrice = round(_sellPrice*0.60);};
			if(_humRank >= 185000 && _humRank < 250000) then {_sellPrice = round(_sellPrice*0.55);};
			if(_humRank >= 250000) then {_sellPrice = round(_sellPrice*0.50);};
			// BANDIT RANK
			if(_humRank <= -5000 && _humRank > -10000) then {_sellPrice = round(_sellPrice*0.99);};
			if(_humRank <= -10000 && _humRank > -15000) then {_sellPrice = round(_sellPrice*0.98);};
			if(_humRank <= -15000 && _humRank > -25000) then {_sellPrice = round(_sellPrice*0.97);};
			if(_humRank <= -25000 && _humRank > -40000) then {_sellPrice = round(_sellPrice*0.96);};
			if(_humRank <= -40000 && _humRank > -60000) then {_sellPrice = round(_sellPrice*0.95);};
			if(_humRank <= -60000 && _humRank > -90000) then {_sellPrice = round(_sellPrice*0.94);};
			if(_humRank <= -90000 && _humRank > -130000) then {_sellPrice = round(_sellPrice*0.93);};
			if(_humRank <= -130000 && _humRank > -185000) then {_sellPrice = round(_sellPrice*0.92);};
			if(_humRank <= -185000 && _humRank > -250000) then {_sellPrice = round(_sellPrice*0.91);};
			if(_humRank <= -250000) then {_sellPrice = round(_sellPrice*0.90);};
		};
	...
	Z_BuyItems = {	
		...
		_humRank = player getVariable['humanity', 0];
		// NO RANK
		if(_humRank < 5000 && _humRank > -5000) then {_priceToBuy = _priceToBuy;};
		// HERO RANK
		if(_humRank >= 5000 && _humRank < 10000) then {_priceToBuy = round(_priceToBuy*0.95);};
		if(_humRank >= 10000 && _humRank < 15000) then {_priceToBuy = round(_priceToBuy*0.90);};
		if(_humRank >= 15000 && _humRank < 25000) then {_priceToBuy = round(_priceToBuy*0.85);};
		if(_humRank >= 25000 && _humRank < 40000) then {_priceToBuy = round(_priceToBuy*0.80);};
		if(_humRank >= 40000 && _humRank < 60000) then {_priceToBuy = round(_priceToBuy*0.75);};
		if(_humRank >= 60000 && _humRank < 90000) then {_priceToBuy = round(_priceToBuy*0.70);};
		if(_humRank >= 90000 && _humRank < 130000) then {_priceToBuy = round(_priceToBuy*0.65);};
		if(_humRank >= 130000 && _humRank < 185000) then {_priceToBuy = round(_priceToBuy*0.60);};
		if(_humRank >= 185000 && _humRank < 250000) then {_priceToBuy = round(_priceToBuy*0.55);};
		if(_humRank >= 250000) then {_priceToBuy = round(_priceToBuy*0.50);};
		// BANDIT RANK
		if(_humRank <= -5000 && _humRank > -10000) then {_priceToBuy = round(_priceToBuy*0.99);};
		if(_humRank <= -10000 && _humRank > -15000) then {_priceToBuy = round(_priceToBuy*0.98);};
		if(_humRank <= -15000 && _humRank > -25000) then {_priceToBuy = round(_priceToBuy*0.97);};
		if(_humRank <= -25000 && _humRank > -40000) then {_priceToBuy = round(_priceToBuy*0.96);};
		if(_humRank <= -40000 && _humRank > -60000) then {_priceToBuy = round(_priceToBuy*0.95);};
		if(_humRank <= -60000 && _humRank > -90000) then {_priceToBuy = round(_priceToBuy*0.94);};
		if(_humRank <= -90000 && _humRank > -130000) then {_priceToBuy = round(_priceToBuy*0.93);};
		if(_humRank <= -130000 && _humRank > -185000) then {_priceToBuy = round(_priceToBuy*0.92);};
		if(_humRank <= -185000 && _humRank > -250000) then {_priceToBuy = round(_priceToBuy*0.91);};
		if(_humRank <= -250000) then {_priceToBuy = round(_priceToBuy*0.90);};
