...
USE_MARKERS = false;			// use trader markers
...
_infiSZ =
[
	[[6326.4805,7809.4888,0],100,true],	// Trader City Stary
	[[4361.4937,2259.9526,0],30,true],	// Wholesaler South
	[[13532.614,6355.9497,0],30,true],	// Wholesaler East
	[[7989.3354,2900.9946,0],30,true],	// Boat Dealer
	[[12060.471,12638.533,0],50,true],	// Aircraft Dealer
	[[1606.6443,7803.5156,0],50,true],	// Bandit Camp
	[[11447.91,11364.536,0],75,true],	// Trader City Klen
	[[13441.16,5429.3013,0],30,true],	// Boat Dealer East
	[[4064.2258,11665.938,0],75,true],	// Trader City Bash
	[[12944.227,12766.889,0],50,true]	// Hero Camp
];
