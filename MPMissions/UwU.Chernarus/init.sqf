...
dayZ_instance = 11; dayz_serverName = "@UwU.Chernarus"; dayzHiveRequest = []; initialized = false; dayz_previousID = 0; player setVariable ["BIS_noCoreConversations", true]; enableRadio false; enableSentences false;
...
if (isServer) then {
	call compile preprocessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Chernarus\dynamic_vehicle.sqf";
	_nil = [] execVM "\z\addons\dayz_server\missions\UwU.Chernarus\mission.sqf";
...
[] execVM "custom\addons\customMap\air.sqf";
[] execVM "custom\addons\customMap\NWAF.sqf";
[] execVM "custom\addons\customMap\balota.sqf";
[] execVM "custom\addons\customMap\northeast.sqf";
[] execVM "custom\addons\customMap\Zeleno_Medbase.sqf";
[] execVM "custom\addons\customMap\military.sqf";
[] execVM "custom\addons\customMap\bridges.sqf";
