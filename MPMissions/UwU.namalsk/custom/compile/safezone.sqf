...
_infiSZ =
[
	[[5769.0625,10774.036,0],75,true],	// Bastion and Alda's Supplies
	[[8885.2803,10757.11,0],75,true],	// Wholesaler Larz
	[[5563.6011,10343.263,0],75,true],	// Dr. Zoidberg
	[[4702.8198,8925.3613,0],75,true],	// Fry and Phil's Weapons/Ammo
	[[3604.1626,8026.2251,0],75,true],	// Tanner's Hero Supplies
	[[7317.5527,8023.3457,0],75,true],	// Bandit Camp
	[[4305.3672,4779.2388,0],75,true],	// Brensk Neutral Camp
	[[2186.3921,5766.6338,0],75,true],	// Dateu's Wholesale
	[[5032.3784,8234.9111,0],75,true],	// Rhevn and Merkaba's Weapons/Ammo
	[[7720.813,5847.5083,0],75,true],	// Popeye's Boats
	[[7239.8848,7046.2319,0],75,true],	// Bandit Trader
	[[6283.353,9380.7344,0],75,true]	// AWOL's Air Vehicles
];
