...
_rndPosX = 2000 + floor(random 7000);
_rndPosY = 5000 + floor(random 7000);
...
TTLapPos = [78.2185, 112.33, 0.00141799]; //(x,y,z)
TTLapDir = 355.368; // set the direction the laptop is facing here
