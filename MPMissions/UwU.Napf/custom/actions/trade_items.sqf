...
private ["_qty","_buy_o_sell","_playerCash","_needed","_started","_finished","_animState","_isMedic","_abort","_removed","_tradeCounter","_traderID","_total_trades","_activatingPlayer","_finish_trade","_name","_textPart","_price","_emptySlots","_free_magazine_slots","_humRank","_sellPrice"];
...
if(_buy_o_sell == "buy") then {
	...
	_sellPrice = (_this select 3) select 2;
	_price = (_this select 3) select 3;
	
	_humRank = player getVariable['humanity', 0];
	// NO RANK
	if(_humRank < 5000 && _humRank > -5000) then {_price = _price;};
	// HERO RANK
	if(_humRank >= 5000 && _humRank < 10000) then {_price = round(_price*0.95);};
	if(_humRank >= 10000 && _humRank < 15000) then {_price = round(_price*0.90);};
	if(_humRank >= 15000 && _humRank < 25000) then {_price = round(_price*0.85);};
	if(_humRank >= 25000 && _humRank < 40000) then {_price = round(_price*0.80);};
	if(_humRank >= 40000 && _humRank < 60000) then {_price = round(_price*0.75);};
	if(_humRank >= 60000 && _humRank < 90000) then {_price = round(_price*0.70);};
	if(_humRank >= 90000 && _humRank < 130000) then {_price = round(_price*0.65);};
	if(_humRank >= 130000 && _humRank < 185000) then {_price = round(_price*0.60);};
	if(_humRank >= 185000 && _humRank < 250000) then {_price = round(_price*0.55);};
	if(_humRank >= 250000) then {_price = round(_price*0.50);};
	// BANDIT RANK
	if(_humRank <= -5000 && _humRank > -10000) then {_price = round(_price*0.99);};
	if(_humRank <= -10000 && _humRank > -15000) then {_price = round(_price*0.98);};
	if(_humRank <= -15000 && _humRank > -25000) then {_price = round(_price*0.97);};
	if(_humRank <= -25000 && _humRank > -40000) then {_price = round(_price*0.96);};
	if(_humRank <= -40000 && _humRank > -60000) then {_price = round(_price*0.95);};
	if(_humRank <= -60000 && _humRank > -90000) then {_price = round(_price*0.94);};
	if(_humRank <= -90000 && _humRank > -130000) then {_price = round(_price*0.93);};
	if(_humRank <= -130000 && _humRank > -185000) then {_price = round(_price*0.92);};
	if(_humRank <= -185000 && _humRank > -250000) then {_price = round(_price*0.91);};
	if(_humRank <= -250000) then {_price = round(_price*0.90);};
