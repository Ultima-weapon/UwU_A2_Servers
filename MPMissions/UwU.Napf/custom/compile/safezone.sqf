...
_infiSZ =
[
        [[8261.6,15496.8,0],100,true],		// Trader City Lenzburg
        [[12413.2,5052.2,0],75,true],		// Trader City Schratten
        [[5154.019,4855.4419,0],100,true],	// Hero Vendor
        [[15128.7,16420.936,0],50,true],	// AWOLs Airfield
        [[2128.2959,7807.7822,0],30,true],	// West Wholesaler
        [[5372.9751,16095.265,0],30,true],	// North Wholesaler
        [[6773.3965,16950.34,0],30,true],	// Nordic Boats
		[[10395.563,8270.3369,0],50,true],	// Bandit Vendor
		[[16864.951,5273.5635,0],30,true],	// Pauls Boats
		[[15504.2,13223.2,0],75,true]		// Trader city Emmen
];
