private ["_body", "_name", "_kills", "_killsH", "_killsB", "_headShots", "_humanity","_method","_methodStr"];
...
<t size='1.25' font='Bitstream' align='left'>Cause of Death: %7 </t>",
_name,_kills,_killsH,_killsB,_headShots,_humanity,_methodStr];