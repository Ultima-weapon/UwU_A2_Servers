...
_infiSZ =
[
        [[431.62454,5554.8208,0],100,true],		// Trader City Khush
        [[1958.948,12555.685,0],100,true],		// Trader City Nur
        [[10870.342,6306.75,0],100,true],	// Trader City Garm
        [[7416.8306,155.77698,0],50,true],	// Wholesaler
        [[11270.841,12660.39,0],50,true],	// Wholesaler
        [[5261.8662,11163.853,0],50,true],	// Airplane Dealer
        [[751.90857,10491.069,0],50,true],	// Bandit Trader
		[[8039.3813,2009.7328,0],50,true]	// Black Market Trader
];
