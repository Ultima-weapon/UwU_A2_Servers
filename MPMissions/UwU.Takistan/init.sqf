...
dayZ_instance = 1; dayz_serverName = "@UwU.Takistan"; dayzHiveRequest = []; initialized = false; dayz_previousID = 0; player setVariable ["BIS_noCoreConversations", true]; enableRadio false; enableSentences false;
...
if (isServer) then {
	call compile preprocessFileLineNumbers "\z\addons\dayz_server\missions\UwU.Takistan\dynamic_vehicle.sqf";
	_nil = [] execVM "\z\addons\dayz_server\missions\UwU.Takistan\mission.sqf";
