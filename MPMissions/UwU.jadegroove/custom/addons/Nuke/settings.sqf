...
_rndPosX = 2000 + floor(random 6000);
_rndPosY = 1000 + floor(random 8000);
...
TTLapPos = [5958.5, 3715.46, 0]; //(x,y,z)
TTLapDir = 288.844; // set the direction the laptop is facing here
